    			...
    			<div id = "CenterContent">
                    <div id = "RegisterFormContent">
                        <form name = "addcontact" method = "POST" onsubmit = "return(validateContacts())">
                            Name:<br/>
                            <input type = "text" name = "contact_name" id = "contact_name"  placeholder = 'Eg.:Satya'><span id = "contact_nameError"></span><br/>
                            Address:<br/>
                            <textarea rows = "4" cols = "34" name = "contact_address" id = "contact_address" placeholder = 'Eg.:No.12, Nehru Street, Balakrishna Nagar'></textarea><span id = "contact_addressError"></span><br/>
                            Mobile No.:<br/>                        
                            <input type = "text" name = "contact_phone_no" id = "contact_phone_no" maxlength = "10" placeholder = 'Enter mobile no'/><span id = "contact_phone_noError"></span><br/>
                            Country:<br/>
