...
<html>
    ...
    <body background = "/images/backgroundAddressBook.jpg">
        <div id = "content">
            ...
            <a id = "addLink" href = "/Contacts/add">Add contact</a>&nbsp; &nbsp;
            ...
            <div id = "section">
                ...
                <table border = "" style = "width :100%"> 
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a class = 'update' href = '/Contacts/update?id=" . $row['contact_id']."'>Edit</a></td>";
                        echo "<td><a class = 'delete' onclick = \"javascript: return confirm('Are you sure you want to delete?');\" href = '/Contacts/delete?id=" . $row['contact_id']."'>Delete</a></td>";
                        echo "</tr>";
                    }   
                    ?>
                    </tbody>
