function validateRegistration()
{
    ...
    if (name == "" || name >= 7 || name <= 15 ) {         
        document.getElementById("nameError").innerHTML = "Name cannot be empty and it must be between 7 t0 15"; 
        var error = false; 
    } 
    if (userName == "") {         
    ...
    //     document.getElementById("passwordError").innerHTML = "Password cannot be empty and it must be between 7 t0 15";
    //     var error = false; 
    // } 
    if (cpassword == "" || cpassword >= 7 || cpassword <=15) {         
        document.getElementById("cpasswordError").innerHTML = "Confirm password cannot be empty and it must be between 7 t0 15"; 
        var error = false; 
    } 
    if (genderM == "" && genderF == "") {
